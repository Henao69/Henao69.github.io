...
console.log(formularioCalculadora);
console.log(resultado);
console.log(retornoButton);
...
function calcularCalorias() {
    ...
    resultado.innerHTML = `
        ...
        <p class="text-center" style="font-size: 20px;">El paciente ${nombre} ${apellido} identificado con ${tipoDocumento} NO.${documento}, requiere un total de <span class="h6" style="font-size: 20px;">${Math.floor(calculoCalorias)} kcal</span> para el sostenimiento de su TBM.</p>
